...
void studentMain() {
    ...
    //benchMark(1000, 1000, 10, 5, 12345, false, true);
    //benchMark(50, 50, 2, 10, 8888, false, true);
    //benchMark(1000, 1000, 100, 100, 5050, false, true);
    //benchMark(75, 200, 10, 10, 1, false, true);
    //benchMark(10, 10, 1, 100, 44, false, true);
    //benchMark(50, 700, 70, 15, 54321, false, true);
